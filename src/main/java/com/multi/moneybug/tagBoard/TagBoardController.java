...
public class TagBoardController {
    ...
    @Autowired
    public TagBoardController(TagBoardService tagBoardService, TagReplyService tagReplyService) {
        this.tagBoardService = tagBoardService;
        this.tagReplyService = tagReplyService;
    }
	...
	public String insert(TagBoardDTO tagBoardDTO, HttpServletRequest request, MultipartFile file, Model model)
	    ...
	    this.tagBoardService.insert(tagBoardDTO); // 파일이 null이든 아니든 데이터 삽입 시도
